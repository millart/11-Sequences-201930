...
def run_test_count_items_bigger_than():
    ...
    # Test 9:
    sequence = [-16, 5, 1524, 111, 16, 0, 8, 22]
    threshold = 17
    expected = 3
    actual = count_items_bigger_than(sequence, threshold)
    print()
    ...
    # Test 10:
    sequence = [88, -27, 96, 4, -4, 27, 36, 18]
    threshold = 14
    expected = 5
    actual = count_items_bigger_than(sequence, threshold)
    print()
...
def run_test_count_positive_sines():
    ...
    # Test 11:
    expected = 3
    actual = count_positive_sines([77, -77, 56, -56, 0, 13])
    print()
...
def run_test_sum_first_n():
    ...
    # Test 8:
    expected = -27
    actual = sum_first_n([34, 5, 12, 0, -78, 9], 5)
    print()
    print('Test 8 expected:', expected)
    print('       actual:  ', actual)
    ...
    # Test 9:
    expected = -18
    actual = sum_first_n([34, 5, 12, 0, -78, 9], 6)
    print()
    print('Test 9 expected:', expected)
    print('       actual:  ', actual)
...
def sum_first_n(numbers, n):
    ...
    for k in range(len(numbers)):
        if k < n:
            sum_of_numbers = sum_of_numbers + numbers[k]
